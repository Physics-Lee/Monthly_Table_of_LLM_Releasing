...
function inferURL(modelName) {
  const infer = [
    ...
    [/^ERNIE Bot/, 'https://www.baidu.com/'],
    [/^ERNIE 3\./, 'https://github.com/PaddlePaddle/PaddleNLP'],
    [/^ERNIE 4\./, 'https://www.baidu.com/'],
    ...
    [/^ERNIE X/, 'https://www.baidu.com/'],
    [/^ChatGLM/, 'https://github.com/THUDM/ChatGLM'],
    [/^GLM-/, 'https://z.ai/'],
    [/^Spark \d/, 'https://www.iflytek.com/'],
