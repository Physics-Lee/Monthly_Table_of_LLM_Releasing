...
function inferURL(modelName) {
  const infer = [
    ...
    [/^ERNIE 3\./, 'https://research.baidu.com/Blog/index-view?id=185'],
    [/^ERNIE 4\./, 'https://yiyan.baidu.com/'],
    [/^ERNIE 5\./, 'https://yiyan.baidu.com/'],
    [/^ERNIE X/, 'https://yiyan.baidu.com/'],
    [/^ChatGLM/, 'https://github.com/THUDM/ChatGLM'],
    [/^GLM-/, 'https://z.ai/'],
    [/^Spark \d/, 'https://xinghuo.xfyun.cn/'],
    [/^Spark X/, 'https://xinghuo.xfyun.cn/'],
    [/^Doubao/, 'https://www.doubao.com/'],
    [/^Moonshot/, 'https://kimi.moonshot.cn/'],
    [/^Kimi/, 'https://kimi.moonshot.cn/'],
    [/^MiniMax/, 'https://www.minimaxi.com/'],
    [/^ABAB \d/, 'https://www.minimaxi.com/'],
    [/^MiLM-/, 'https://github.com/XiaoMi/MiLM-6B'],
    [/^MiMo/, 'https://github.com/XiaomiMiMo'],
    [/^Zhixiaobao/, 'https://www.xiaomi.com/'],
